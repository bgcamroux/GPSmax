...
- [1. Project Summary](#1-project-summary)
  - [What `GPSmax` *is*](#what-gpsmax-is)
  - [Design philosophy](#design-philosophy)
  - [What `GPSmax` is *not*](#what-gpsmax-is-not)
  - [User workflow](#user-workflow)
- [2. Current inventory](#2-current-inventory)
  - [Current directory layout](#current-directory-layout)
  - [User entry points](#user-entry-points)
  - [Persistent artifacts and on-disk layout](#persistent-artifacts-and-on-disk-layout)
- [3. What works well](#3-what-works-well)
  - [Clear separation of data lifecycles](#clear-separation-of-data-lifecycles)
  - [Preservation of original data](#preservation-of-original-data)
  - [Deterministic ingestion with verification](#deterministic-ingestion-with-verification)
  - [Explicit, human-readable artifacts](#explicit-human-readable-artifacts)
  - [Human-in-the-loop workflow](#human-in-the-loop-workflow)
  - [Modular functional domains](#modular-functional-domains)
  - [Minimal mandatory infrastructure](#minimal-mandatory-infrastructure)
- [4. Pain points and limitations](#4-pain-points-and-limitations)
  - [I. Fragmented user entry points](#i-fragmented-user-entry-points)
  - [II. Blurred boundaries: procedural vs data logic](#ii-blurred-boundaries-procedural-vs-data-logic)
  - [III. Inconsistent or unstable on-disk conventions](#iii-inconsistent-or-unstable-on-disk-conventions)
  - [IV. Manifest and database ambiguity](#iv-manifest-and-database-ambiguity)
  - [V. Limited visibility into workflow state](#v-limited-visibility-into-workflow-state)
  - [VI. Naming drift and conceptual overlap](#vi-naming-drift-and-conceptual-overlap)
- [5. Key risks](#5-key-risks)
  - [I. Maintainability risk](#i-maintainability-risk)
  - [II. Data integrity risk](#ii-data-integrity-risk)
  - [III. User interface and experience risk](#iii-user-interface-and-experience-risk)
  - [IV. Architectural scalability risk](#iv-architectural-scalability-risk)
- [6. Target architecture](#6-target-architecture)
  - [I. Single, unified entry point](#i-single-unified-entry-point)
  - [II. Explicit separation of responsibilities](#ii-explicit-separation-of-responsibilities)
  - [III. Stable, well-defined data boundaries](#iii-stable-well-defined-data-boundaries)
  - [IV. Authoritative sources of truth](#iv-authoritative-sources-of-truth)
  - [V. Incremental extensibility](#v-incremental-extensibility)
  - [VI. Constraints and non-goals](#vi-constraints-and-non-goals)
- [7. Migration plan](#7-migration-plan)
  - [Guiding constraints](#guiding-constraints)
  - [Milestone 1: Establish unified interface without changing behaviour](#milestone-1-establish-unified-interface-without-changing-behaviour)
  - [Milestone 2: Stabilize cross-cutting concerns](#milestone-2-stabilize-cross-cutting-concerns)
  - [Milestone 3: Make data boundaries explicit and stable](#milestone-3-make-data-boundaries-explicit-and-stable)
  - [Milestone 4: Clarify authoritative sources of truth (filesystem vs. database)](#milestone-4-clarify-authoritative-sources-of-truth-filesystem-vs-database)
  - [Milestone 5: Enforce separation of responsibilities (layers)](#milestone-5-enforce-separation-of-responsibilities-layers)
  - [Milestone 6: Deprecate legacy entry points and reduce surface area](#milestone-6-deprecate-legacy-entry-points-and-reduce-surface-area)
  - [Deprecation policy](#deprecation-policy)
  - [Validation strategy: Applies across milestones](#validation-strategy-applies-across-milestones)
